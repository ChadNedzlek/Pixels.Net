...
internal static partial class NativeMethods
{
    ...
    internal static extern CallResult GetManufacturerData(SafePeripheralHandle peripheral, nuint index, ref BleManufacturerData data);
    ...
    internal static extern CallResult OnNotify(SafePeripheralHandle peripheral, [MarshalAs(UnmanagedType.Struct)]BleUuid service, [MarshalAs(UnmanagedType.Struct)]BleUuid characteristic, NotifyCallback callback, IntPtr data);
    [DllImport(SimpleBleLibraryName, EntryPoint = "simpleble_peripheral_write_request")]
    internal static extern unsafe CallResult WriteRequest(SafePeripheralHandle peripheral, [MarshalAs(UnmanagedType.Struct)]BleUuid service, [MarshalAs(UnmanagedType.Struct)]BleUuid characteristic,  ref byte data, nuint length);
